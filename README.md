...
Instructions to create a KarmaData React App
1. [Bootstrap using Facebook create-react-app](#bootstrap-create-react-app)
2. [Bootstrap mobx](#bootstrap-mobx)
3. [Bootstrap karmadata](#bootstrap-karmadata)

# Bootstrap create react app

1. If you do not have create-react-app installed globally (one time)
```
Mac Users: (root admin)
sudo npm install -g create-react-app
```

2. navigate to the directory and create your app using facebook standard for React

```
start Terminal in root directory cd..
create-react-app kd-react-sample-apps
cd kd-react-sample-apps/
```

# Bootstrap karmadata
```
npm install karmadata --save
...
``npm install {fav-package-name} --save``
